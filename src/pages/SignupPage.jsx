...
const SignupPage = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    setTimeout(() => {
      ...
      const dashboardRoute = formData.role === 'instructor' ? '/instructor-dashboard' : '/student-dashboard'
        ...
        <div className="bg-white dark:bg-gray-800 py-8 px-4 shadow-xl rounded-2xl sm:px-10 border border-gray-200 dark:border-gray-700">
          <form className="space-y-6" onSubmit={handleSubmit}>
                ...
                <label className={`relative flex cursor-pointer rounded-lg border p-4 focus:outline-none transition-all ${
                  ...
                  <span className="flex flex-1">
                    <span className="flex flex-col">
                      ...
                      <span className="mt-1 text-xs text-gray-500 dark:text-gray-400">Learn from courses</span>
                    </span>
                  </span>
                  {formData.role === 'student' && (
                ...
                <label className={`relative flex cursor-pointer rounded-lg border p-4 focus:outline-none transition-all ${
                  ...
                  <span className="flex flex-1">
                    <span className="flex flex-col">
                      ...
                      <span className="mt-1 text-xs text-gray-500 dark:text-gray-400">Create & teach</span>
                    </span>
                  </span>
                  {formData.role === 'instructor' && (
                    <Check className="h-5 w-5 text-primary-600" />
            ...
            <div>
              ...
              <div className="mt-1 relative">
                ...
                <input
                  ...
                  onChange={handleInputChange}
                  className={`appearance-none block w-full pl-10 pr-10 py-3 border rounded-lg placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-primary-500 focus:border-transparent transition-all ${
                    errors.password 
                      ? 'border-red-300 dark:border-red-600' 
                      : 'border-gray-300 dark:border-gray-600'
                  } bg-white dark:bg-gray-700 text-gray-900 dark:text-white`}
            ...
            <div>
              ...
              {errors.agreeToTerms && (
                <p className="mt-2 text-sm text-red-600 dark:text-red-400">{errors.agreeToTerms}</p>
              )}
            </div>
            ...
            <div>
              <button
                ...
                disabled={isLoading}
                className="w-full inline-flex justify-center py-3 px-4 border border-gray-300 dark:border-gray-600 rounded-lg shadow-sm bg-white dark:bg-gray-700 text-sm font-medium text-gray-500 dark:text-gray-300 hover:bg-gray-50 dark:hover:bg-gray-600 transition-all duration-200 hover:scale-105 active:scale-95 disabled:opacity-50 disabled:cursor-not-allowed disabled:hover:scale-100"
              >
